<template>
  <div class="checkoutn_warpper mobileV">
    ...
    <div class="btn_warpper">
      <InsButton style="display:inline-block;margin-top:20px" class="btnStyle" width="100%" size="middle" :nama="$t('CheckOut.Checkout')"
        @click="checkOut" :loading="COloading" />
      <InsButton v-show="checkouting" style="display:inline-block;" class="btnStyle" width="100%" size="middle" :nama="$t('CheckOut.BacktoShoppingCart')"
        @click="Hyperlink" />
    </div>
  </div>
</template>
